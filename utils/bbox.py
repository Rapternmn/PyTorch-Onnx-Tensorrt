...
def bbox_iou(box1, box2 , CUDA = True):
	...
	# print("inter_rect_x1 type = {}".format(inter_rect_x1.dtype))
	# print("inter_rect_y1 type = {}".format(inter_rect_y1.dtype))
	# print("inter_rect_x2 type = {}".format(inter_rect_x2.dtype))
	# print("inter_rect_y2 type = {}".format(inter_rect_y2.dtype))
